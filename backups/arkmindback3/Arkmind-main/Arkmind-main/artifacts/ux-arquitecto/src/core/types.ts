...
export interface BifurcationSummary {
  topics: string[];
  decisions_taken: Decision[];
  decisions_open: Decision[];
  decisions_denied: Decision[];
...
export interface AIContextSession {
  ...
  // Optional summary attached to forks to aid navigation and decision-making
  bifurcationSummary?: BifurcationSummary;
}
